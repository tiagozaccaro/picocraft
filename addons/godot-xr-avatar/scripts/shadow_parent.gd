...
@onready var left_foot : BoneAttachment3D = $FPController/avatar/Armature/Skeleton3D/left_foot
@onready var right_foot : BoneAttachment3D = $FPController/avatar/Armature/Skeleton3D/right_foot
@onready var LL_ik : SkeletonIK3D = $FPController/avatar/Armature/Skeleton3D/SkeletonIKLegL
@onready var RL_ik : SkeletonIK3D = $FPController/avatar/Armature/Skeleton3D/SkeletonIKLegR
...
func _ready():
	...
	player_arvrcamera = get_parent().get_node("avatar_player/FPController/XRCamera3D")
	...
	$FPController/avatar/Armature/Skeleton3D/SkeletonIKL.set_target_node(NodePath("../../../../" + left_controller.name + "/" + left_hand.name + "/left_target"))
	$FPController/avatar/Armature/Skeleton3D/SkeletonIKR.set_target_node(NodePath("../../../../" + right_controller.name + "/" + right_hand.name + "/right_target"))
	...
	#start the IK
	$FPController/avatar/Armature/Skeleton3D/SkeletonIKL.start()
	$FPController/avatar/Armature/Skeleton3D/SkeletonIKR.start()
	LL_ik.start()
	RL_ik.start()
...
func _physics_process(delta):
	...
	if abs(move.y) > .25 and get_current_player_height() < (.9 * max_height):
		$FPController/avatar/Armature/Skeleton3D/SkeletonIKLegL.magnet = lerp($FPController/avatar/Armature/Skeleton3D/SkeletonIKLegL.magnet, Vector3(1,3,3), delta)
		$FPController/avatar/Armature/Skeleton3D/SkeletonIKLegR.magnet = lerp($FPController/avatar/Armature/Skeleton3D/SkeletonIKLegR.magnet, Vector3(-1,3,3), delta)
	else:
		$FPController/avatar/Armature/Skeleton3D/SkeletonIKLegL.magnet = lerp($FPController/avatar/Armature/Skeleton3D/SkeletonIKLegL.magnet, Vector3(.2,0,1), delta)
		$FPController/avatar/Armature/Skeleton3D/SkeletonIKLegR.magnet = lerp($FPController/avatar/Armature/Skeleton3D/SkeletonIKLegR.magnet, Vector3(-.2,0,1), delta)
