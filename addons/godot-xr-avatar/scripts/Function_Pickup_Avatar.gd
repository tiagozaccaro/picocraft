...
## Grab collision mask
@export (int, LAYERS_3D_PHYSICS) var grab_collision_mask = 1: set = _set_grab_collision_mask
...
## Ranged-grab angle
@export (float, 0.0, 45.0) var ranged_angle: float = 5.0: set = _set_ranged_angle

## Ranged-grab collision mask
@export (int, LAYERS_3D_PHYSICS) var ranged_collision_mask = 1: set = _set_ranged_collision_mask
...
## Set nodes 
@onready var _controller : XRController3D = get_node(grabbing_controller_nodepath)
...
func _ready():
	...
	_grab_area.connect("area_entered", Callable(self, "_on_grab_entered"))
	_grab_area.connect("body_entered", Callable(self, "_on_grab_entered"))
	_grab_area.connect("area_exited", Callable(self, "_on_grab_exited"))
	_grab_area.connect("body_exited", Callable(self, "_on_grab_exited"))
	...
	_ranged_area.connect("area_entered", Callable(self, "_on_ranged_entered"))
	_ranged_area.connect("body_entered", Callable(self, "_on_ranged_entered"))
	_ranged_area.connect("area_exited", Callable(self, "_on_ranged_exited"))
	_ranged_area.connect("body_exited", Callable(self, "_on_ranged_exited"))
	...
	# Monitor Grab Button
	_controller.connect("button_pressed", Callable(self, "_on_button_pressed"))
	_controller.connect("button_released", Callable(self, "_on_button_release"))
